...
Shader "InPlanaria/AmplifyTriplanar"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float DetialMaskVar62 = triplanar58.z;
			float3 lerpResult130 = lerp( normalizeResult133 , tanTriplanarNormal11 , DetialMaskVar62);
			o.Normal = lerpResult130;
			float2 temp_cast_5 = (DetialTexWorldScaleVar52).xx;
			float4 triplanar27 = TriplanarSampling27( _DetailAlbedoMap, _DetailAlbedoMap, _DetailAlbedoMap, ase_worldPos, ase_worldNormal, DetialCoverageFalloffVar53, temp_cast_5, float3( 1,1,1 ), float3(0,0,0) );
			float2 temp_cast_11 = (TexWorldScaleVar34).xx;
			float4 triplanar10 = TriplanarSampling10( _MainTex, _MainTex, _MainTex, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_11, float3( 1,1,1 ), float3(0,0,0) );
			o.Albedo = ( ( float4(1,1,1,1) + ( ( ( ( ( _DetialColor * triplanar27 ) * float4(2,2,2,2) ) * float4(2,2,2,2) ) + float4(-1,-1,-1,-1) ) * DetialMaskVar62 ) ) * ( _Color * triplanar10 ) ).xyz;
			float2 temp_cast_15 = (TexWorldScaleVar34).xx;
			float4 triplanar25 = TriplanarSampling25( _EmissionMap, _EmissionMap, _EmissionMap, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_15, float3( 1,1,1 ), float3(0,0,0) );
			o.Emission = ( triplanar25 * _EmissionColor ).xyz;
			float2 temp_cast_18 = (TexWorldScaleVar34).xx;
			float4 triplanar17 = TriplanarSampling17( _MetallicGlossMap, _MetallicGlossMap, _MetallicGlossMap, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_18, float3( 1,1,1 ), float3(0,0,0) );
			o.Metallic = ( _Metallic * triplanar17.x );
			o.Smoothness = ( triplanar17.a * _Glossiness );
			float2 temp_cast_19 = (TexWorldScaleVar34).xx;
			float4 triplanar115 = TriplanarSampling115( _OcclusionMap, _OcclusionMap, _OcclusionMap, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_19, float3( 1,1,1 ), float3(0,0,0) );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;54;-1570.216,1553.021;Float;False;Property;_DetialCoverageFalloff;DetialCoverageFalloff;20;0;Create;True;0;0;0;False;0;False;2.794423;2.794423;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-1580.209,1439.685;Float;False;Property;_DetialTexWorldScale;_DetialTexWorldScale;23;0;Create;True;0;0;0;False;0;False;1;1;0.0001;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;26;-878.1637,1531.208;Float;True;Property;_DetailAlbedoMap;_DetailAlbedoMap;13;0;Create;True;0;0;0;False;0;False;None;4d4faa6fb270f4b43a9a1fe4ac39d46f;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;61;332.5174,2271.562;Float;False;Property;_DetialMaskCoverageFalloff;DetialMaskCoverageFalloff;21;0;Create;True;0;0;0;False;0;False;2.794423;2.794423;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;59;316.6721,2015.301;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;60;332.7093,2189.995;Float;False;Property;_DetialMaskTexWorldScale;_DetialMaskTexWorldScale;24;0;Create;True;0;0;0;False;0;False;1;1;0.0001;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-1717.729,121.6341;Float;False;Property;_CoverageFalloff;Coverage Falloff;19;0;Create;True;0;0;0;False;0;False;1;1;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1699.096,-4.48207;Float;False;Property;_TexWorldScale;_TexWorldScale;22;0;Create;True;0;0;0;False;0;False;1;1;0.0001;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;56;101.5591,1808.22;Float;True;Property;_DetailMask;_DetailMask;11;1;[Header];Create;True;1;DetailMask(B);0;0;False;0;False;None;955236b9aefd24d40ae1cade01623112;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector4Node;125;-65.43929,-746.2775;Inherit;False;Constant;_Vector0;Vector 0;24;0;Create;True;0;0;0;False;0;False;2,2,2,2;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;135;253.3049,-869.3515;Inherit;False;Constant;_Vector1;Vector 0;24;0;Create;True;0;0;0;False;0;False;2,2,2,2;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;185.3031,-531.0215;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0.447,0.447,0.447,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-710.9298,229.8041;Float;False;Property;_BumpScale;_BumpScale;6;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-888.8054,2055.461;Float;False;Property;_DetailNormalMapScale;_DetailNormalMapScale;18;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-986.2088,140.0887;Float;True;Property;_BumpMap;_BumpMap;5;0;Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;29;-882.284,1848.789;Float;True;Property;_DetailNormalMap;_DetailNormalMap;17;0;Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;136;565.6818,-564.2911;Inherit;False;Constant;_Vector2;Vector 0;24;0;Create;True;0;0;0;False;0;False;-1,-1,-1,-1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;137;425.4455,-632.6608;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0.447,0.447,0.447,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;116;1295.391,958.3541;Float;True;Property;_OcclusionMap;_OcclusionMap;7;1;[Header];Create;True;1;Occlusion(G);0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;94;-711.1421,-226.5307;Float;True;Property;_MainTex;_MainTex;1;0;Create;True;0;0;0;False;0;False;None;750b1bd7ba8bd28489650de6d0a95cc5;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleAddOpNode;138;856.9608,-670.981;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;139;821.6979,-533.687;Inherit;False;62;DetialMaskVar;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-350.7862,-297.1028;Inherit;False;Property;_Color;_Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.72,0.72,0.72,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;101;1236.96,787.7277;Float;False;Property;_OcclusionStrength;_OcclusionStrength;8;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;140;454.123,-914.7252;Inherit;False;Constant;_Vector3;Vector 0;24;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;1061.872,-662.5135;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0.447;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;142;1245.717,-686.3835;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;77;-1072.01,2393.61;Float;True;Property;_DetialMetallicGlossMap;_DetialMetallicGlossMap;14;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;84;-329.3368,2677.88;Float;False;Property;_DetialGlossiness;_DetialGlossiness;16;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-521.1276,2339.93;Float;False;Property;_DetialMetallic;_DetialMetallic;15;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;143;1387.67,-657.7939;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.OneMinusNode;134;1257.537,2072.34;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;144;2443.193,293.3169;Inherit;False;Property;_StencilWriteMask;StencilWriteMask;38;0;Create;True;0;0;0;True;0;False;255;255;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;145;2436.947,204.7493;Inherit;False;Property;_StencilReadMask;StencilReadMask;37;0;Create;True;0;0;0;True;0;False;255;255;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;146;2473.501,392.0396;Inherit;False;Property;_StencilComp;StencilComp;39;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;8;8;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;147;2478.302,488.639;Inherit;False;Property;_StencilPass;StencilPass;40;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;148;2498.302,561.6388;Inherit;False;Property;_StencilFail;StencilFail;41;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;149;2496.302,632.6389;Inherit;False;Property;_StencilZFail;StencilZFail;42;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;150;2468.632,127.7623;Inherit;False;Property;_StencilRef;StencilRef;36;0;Create;True;0;0;0;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;151;2181.072,374.1584;Inherit;False;Property;_ZWrite;ZWrite;26;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;152;2180.072,458.1582;Inherit;False;Property;_ZTest;ZTest;27;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.CompareFunction;True;0;False;4;4;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;153;2187.393,564.2458;Inherit;False;Property;_MaskClipValue;MaskClipValue;28;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;154;2190.058,652.1706;Inherit;False;Property;_AlphaToCoverage;Alpha To Coverage;29;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;155;2176.668,293.4965;Inherit;False;Property;_Cull;Cull;25;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;156;2196.719,745.4246;Inherit;False;Property;_BlendRGBSrc;BlendRGBSrc;30;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendMode;True;0;False;5;5;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;157;2200.714,822.6916;Inherit;False;Property;_BlendRGBDst;BlendRGBDst;31;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendMode;True;0;False;10;10;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;158;2200.563,891.1076;Inherit;False;Property;_BlendOpRGB;BlendOpRGB;32;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;159;2203.056,973.2216;Inherit;False;Property;_BlendAlphaSrc;BlendAlphaSrc;33;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendMode;True;0;False;5;5;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;160;2207.051,1050.489;Inherit;False;Property;_BlendAlphaDst;BlendAlphaDst;34;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendMode;True;0;False;10;10;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;161;2212.261,1135.508;Inherit;False;Property;_BlendOpAlpha;BlendOpAlpha;35;1;[Enum];Create;True;0;2;OFF;0;ON;1;1;UnityEngine.Rendering.BlendOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1612.066,160.7364;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;InPlanaria/AmplifyTriplanar;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;True;_ZWrite;0;True;_ZTest;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;True;0;True;_StencilRef;255;True;_StencilReadMask;255;True;_StencilWriteMask;0;True;_StencilComp;0;True;_StencilPass;0;True;_StencilFail;0;True;_StencilZFail;0;True;_StencilComp;0;True;_StencilPass;0;True;_StencilFail;0;True;_StencilZFail;False;2;15;10;25;False;0.5;True;1;0;True;_BlendRGBSrc;0;True;_BlendRGBDst;1;0;True;_BlendAlphaSrc;0;True;_BlendAlphaDst;0;True;_BlendOpRGB;0;True;_BlendOpAlpha;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_Cull;-1;0;True;_MaskClipValue;0;0;0;False;0.1;False;;0;True;_AlphaToCoverage;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=1CC027EBD1DD73FD506C1D7B6C8971348650C247