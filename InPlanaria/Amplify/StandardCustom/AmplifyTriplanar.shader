...
Shader "InPlanaria/AmplifyTriplanar"
{
	Properties
	{
		...
		_DetialMetallicGlossMap("_DetialMetallicGlossMap", 2D) = "gray" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_93_0 = ( _DetialColor * triplanar27 );
			float2 temp_cast_8 = (TexWorldScaleVar34).xx;
			float4 triplanar10 = TriplanarSampling10( _MainTex, _MainTex, _MainTex, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_8, float3( 1,1,1 ), float3(0,0,0) );
			float4 temp_output_13_0 = ( _Color * triplanar10 );
			float4 blendOpSrc98 = ( temp_output_93_0 * float4(2,2,2,2) );
			float4 blendOpDest98 = temp_output_13_0;
			float4 lerpBlendMode98 = lerp(blendOpDest98,(( blendOpDest98 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest98 ) * ( 1.0 - blendOpSrc98 ) ) : ( 2.0 * blendOpDest98 * blendOpSrc98 ) ),DetialMaskVar62);
			o.Albedo = ( saturate( lerpBlendMode98 )).rgb;
			float2 temp_cast_11 = (TexWorldScaleVar34).xx;
			float4 triplanar25 = TriplanarSampling25( _EmissionMap, _EmissionMap, _EmissionMap, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_11, float3( 1,1,1 ), float3(0,0,0) );
			o.Emission = ( triplanar25 * _EmissionColor ).xyz;
			float2 temp_cast_14 = (TexWorldScaleVar34).xx;
			float4 triplanar17 = TriplanarSampling17( _MetallicGlossMap, _MetallicGlossMap, _MetallicGlossMap, ase_worldPos, ase_worldNormal, CoverageFalloffVar40, temp_cast_14, float3( 1,1,1 ), float3(0,0,0) );
			float2 temp_cast_15 = (DetialTexWorldScaleVar52).xx;
			float4 triplanar81 = TriplanarSampling81( _DetialMetallicGlossMap, _DetialMetallicGlossMap, _DetialMetallicGlossMap, ase_worldPos, ase_worldNormal, DetialCoverageFalloffVar53, temp_cast_15, float3( 1,1,1 ), float3(0,0,0) );
			...
			o.Occlusion = ( tex2D( _OcclusionMap, uv_OcclusionMap ).g * _OcclusionStrength );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;61;332.5174,2271.562;Float;False;Property;_DetialMaskCoverageFalloff;DetialMaskCoverageFalloff;15;0;Create;True;0;0;0;False;0;False;2.794423;2.794423;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;59;316.6721,2015.301;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TexturePropertyNode;56;193.5591,1808.22;Float;True;Property;_DetailMask;_DetailMask;0;0;Create;True;0;0;0;False;0;False;None;None;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;60;332.7093,2189.995;Float;False;Property;_DetialMaskTexWorldScale;_DetialMaskTexWorldScale;18;0;Create;True;0;0;0;False;0;False;1;0.41;0.0001;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-1570.216,1553.021;Float;False;Property;_DetialCoverageFalloff;DetialCoverageFalloff;14;0;Create;True;0;0;0;False;0;False;2.794423;2.794423;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-1580.209,1439.685;Float;False;Property;_DetialTexWorldScale;_DetialTexWorldScale;17;0;Create;True;0;0;0;False;0;False;1;0.65;0.0001;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1717.729,121.6341;Float;False;Property;_CoverageFalloff;Coverage Falloff;13;0;Create;True;0;0;0;False;0;False;1;1;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1699.096,-4.48207;Float;False;Property;_TexWorldScale;_TexWorldScale;16;0;Create;True;0;0;0;False;0;False;1;0.45;0.0001;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;26;-878.1637,1529.6;Float;True;Property;_DetailAlbedoMap;_DetailAlbedoMap;1;0;Create;True;0;0;0;False;0;False;None;None;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.IntNode;71;1177.588,1693.055;Inherit;False;Property;_DetailMaskInvert;_DetailMaskInvert;25;0;Create;True;0;0;0;False;0;False;0;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;77;-1027.523,2451.181;Float;True;Property;_DetialMetallicGlossMap;_DetialMetallicGlossMap;6;0;Create;True;0;0;0;False;0;False;None;None;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;100;831.3519,-278.2394;Inherit;False;Constant;_Vector0;Vector 0;24;0;Create;True;0;0;0;False;0;False;2,2,2,2;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-710.9298,229.8041;Float;False;Property;_BumpScale;_BumpScale;19;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-521.1276,2339.93;Float;False;Property;_DetialMetallic;_DetialMetallic;12;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-986.2088,140.0887;Float;True;Property;_BumpMap;_BumpMap;2;0;Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.GetLocalVarNode;63;1085.385,-26.68836;Inherit;False;62;DetialMaskVar;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;99;1055.054,-164.6294;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0.447,0.447,0.447,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;101;1236.96,787.7277;Float;False;Property;_OcclusionStrength;_OcclusionStrength;11;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;102;1271.406,569.1713;Inherit;True;Property;_OcclusionMap;_OcclusionMap;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BlendOpsNode;98;1316.765,-128.3945;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;57;590.379,-452.219;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;103;1617.122,705.1245;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=9C4D6584AF27D82C72DE08209D37C194A96E78BD