...
Shader "InPlanaria/AmplifyStandard"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_93_0 = ( _DetialColor * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) );
			float2 uv_MainTex = i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
			float4 temp_output_13_0 = ( _Color * tex2D( _MainTex, uv_MainTex ) );
			float4 blendOpSrc104 = ( temp_output_93_0 * float4(2,2,2,2) );
			float4 blendOpDest104 = temp_output_13_0;
			float4 lerpBlendMode104 = lerp(blendOpDest104,(( blendOpDest104 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest104 ) * ( 1.0 - blendOpSrc104 ) ) : ( 2.0 * blendOpDest104 * blendOpSrc104 ) ),DetialMaskVar62);
...
Node;AmplifyShaderEditor.IntNode;71;1129.588,1962.055;Inherit;False;Property;_DetailMaskInvert;_DetailMaskInvert;18;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.ColorNode;92;-429.8023,1325.348;Inherit;False;Property;_DetialColor;_DetialColor;16;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,0.6156863,0.4509804,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;12;-350.7862,-297.1028;Inherit;False;Property;_Color;_Color;15;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-888.8054,2055.461;Float;False;Property;_DetailNormalMapScale;_DetailNormalMapScale;14;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;106;730.5237,-276.8836;Inherit;False;Constant;_Vector0;Vector 0;24;0;Create;True;0;0;0;False;0;False;2,2,2,2;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;23;-311.6849,1143.85;Inherit;False;Property;_EmissionColor;_EmissionColor;17;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;105;954.2257,-163.2736;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0.447,0.447,0.447,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;103;1008.573,-36.04035;Inherit;False;62;DetialMaskVar;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;108;792.5922,950.2809;Float;False;Property;_OcclusionStrength;_OcclusionStrength;11;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;107;827.0381,731.7245;Inherit;True;Property;_OcclusionMap;_OcclusionMap;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BlendOpsNode;104;1216.937,-127.0387;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;109;1172.755,867.6776;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4395B00181EA3637ABC11B38C4888E7891A45B3B